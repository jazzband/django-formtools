...
class NamedWizardTests:
    ...
    def test_initial_call_with_params(self):
        ...
        response = self.client.get(
            reverse('%s_start' % self.wizard_urlname), get_params
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_cleaned_data(self):
        ...
        self.assertEqual(
            form_dict['form1'].cleaned_data, response.context['form_list'][0]
        )
...
class NamedFormTests:
    def test_revalidation(self):
        ...
        testform = self.formwizard_class.as_view(
            [('start', Step1), ('step2', Step2)], url_name=self.wizard_urlname
        )
